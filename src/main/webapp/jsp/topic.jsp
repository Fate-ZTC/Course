...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">
            <div class="col-md-19">
                <form action="${pageContext.request.contextPath}/select.action?id=${id}" method="post">
                <div class="card">
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${topicList}" var="item">
                                    <tr>
                                        ...
                                        <td>${item.toid}</td>
                                        <td>${item.toname}</td>
                                        <td><input  type="checkbox" name="ids" value="${item.toid}"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><input type="submit" value="确认选择课题"/></td>
                                    </tr>
                            </table>
                        </div>
                    </div>
